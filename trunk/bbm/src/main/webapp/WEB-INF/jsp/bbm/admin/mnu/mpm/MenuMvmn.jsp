...
function selectMenuListTmp() {
	document.menuListForm.req_RetrunPath.value = "<c:url value='/admin/mnu/mpm/MenuMvmn'/>";
    document.menuListForm.action = "<c:url value='/admin/mnu/mpm/MenuListSelectTmp.do'/>";
...
<form name="searchUpperMenuIdForm" action ="<c:url value='/admin/mnu/mpm/MenuListSelectTmp.do'/>" method="post">
<div style="visibility:hidden;display:none;"><input name="iptSubmit" type="submit" value="전송" title="전송"></div>
<input type="hidden" name="req_RetrunPath" value="/admin/mnu/mpm/EgovMenuMvmn">
