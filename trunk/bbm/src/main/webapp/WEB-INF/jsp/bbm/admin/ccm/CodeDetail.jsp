...
<%
 /**
  * @Class Name  : CodeDetail.jsp
  * @Description : CodeDetail 화면
...
function fnModify(){
	...
	varForm.action           = "<c:url value='/admin/ccm/CodeModify.do'/>";
...
function fnDelete(){
	if (confirm("<spring:message code='common.delete.msg'/>")) {
		var varForm				 = document.getElementById("Form");
		varForm.action           = "<c:url value='/admin/ccm/CodeRemove.do'/>";
		varForm.codeId.value     = "${result.codeId}";
		varForm.submit();
	}
}
