...
<%
  ...
  */
  ...
  /* Image Path 설정 */
  String imagePath_icon   = "/images/bbm/admin/mnu/mcm/icon/";
  String imagePath_button = "/images/bbm/admin/mnu/mcm/button/";
%>
<html lang="ko">
<head>
...
<script language="javascript1.2" type="text/javaScript" src="<c:url value='/js/bbm/admin/mnu/mcm/EgovMenuCreatSiteMap.js' />"></script>
...
//var vSiteMapPath = "/html/bbm/admin/mnu/mcm/";
