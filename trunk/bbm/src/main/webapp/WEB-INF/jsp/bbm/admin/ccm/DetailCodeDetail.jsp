...
<%
 /**
  * @Class Name  : DetailCodeDetail.jsp
  * @Description : DetailCodeDetail 화면
...
function fnModify(){
	...
	varForm.action           = "<c:url value='/admin/ccm/DetailCodeModify.do'/>";
...
function fnDelete(){
	if (confirm("<spring:message code='common.delete.msg'/>")) {
		var varForm				 = document.getElementById("Form");
		varForm.action           = "<c:url value='/admin/ccm/DetailCodeRemove.do'/>";
		varForm.codeId.value     = "${result.codeId}";
		varForm.code.value       = "${result.code}";
		varForm.submit();
	}
