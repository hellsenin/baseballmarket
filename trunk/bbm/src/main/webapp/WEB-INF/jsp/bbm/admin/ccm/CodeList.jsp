...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/admin/ccm/CodeList.do'/>";
 ...
 ******************************************************** */
function fnRegist(){
	location.href = "<c:url value='/admin/ccm/CodeRegist.do' />";
}
/* ********************************************************
 * 수정 처리 함수
 ******************************************************** */
...
function fnDetail(codeId){
	...
	varForm.action           = "<c:url value='/admin/ccm/CodeDetail.do'/>";
...
<form name="listForm" action="<c:url value='/admin/ccm/CodeList.do'/>" method="post">
...
<tr style="cursor:pointer;cursor:hand;" onclick="javascript:fnDetail('${resultInfo.codeId}');">
	...
	<td class="lt_text" nowrap>
		<span class="link">
			<a href="<c:url value='/admin/ccm/CodeDetail.do'/>?codeId=${resultInfo.codeId}" onclick="javascript:fnDetail('${resultInfo.codeId}');">
			${resultInfo.codeIdNm}
			</a>
		</span>
	</td>
