...
<%
 /**
  * @Class Name  : ClCodeDetail.jsp
  * @Description : ClCodeDetail 화면
...
function fnModify(){
	...
	varForm.action           = "<c:url value='/admin/ccm/ClCodeModify.do'/>";
...
function fnDelete(){
	if (confirm("<spring:message code="common.delete.msg" />")) {
		var varForm				 = document.getElementById("Form");
		varForm.action           = "<c:url value='/admin/ccm/ClCodeRemove.do'/>";
		varForm.clCode.value     = "${result.clCode}";
		varForm.submit();
	}
}
