...
function linkPage(pageNo){
	...
	document.progrmManageForm.action = "<c:url value='/admin/prm/ProgramListSearch.do'/>";
...
<body>
<form name="progrmManageForm" action ="<c:url value='/admin/prm/ProgramListSearch.do'/>" method="post">
