...
import com.bbm.uss.umt.service.DeptManageService;
...
public class DeptManageController {
    ...
    private DeptManageService egovDeptManageService;
    ...
    public String selectDeptManageListView() throws Exception {
        ...
        return "bbm/uss/umt/DeptManageList";
    }   	
	...
	public String selectDeptManage(@RequestParam("orgnztId") String orgnztId, 
    	...
    	model.addAttribute("message", egovMessageSource.getMessage("success.common.select"));
    	return "bbm/uss/umt/DeptManageUpdt";
	}
	...
	public String insertViewDeptManage(@ModelAttribute("deptManageVO") DeptManageVO deptManageVO,
    	...
    	return "bbm/uss/umt/DeptManageInsert";
	}
