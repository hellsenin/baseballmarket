...
import com.bbm.uss.umt.service.EntrprsManageService;
import com.bbm.uss.umt.service.EntrprsManageVO;
...
public class EntrprsManageController {
     ...
     * @param model 화면모델
     * @return uss/umt/EntrprsMberInsert
     * @throws Exception
     */
    @RequestMapping("/uss/umt/EntrprsMberInsertView.do")
    public String insertEntrprsMberView(
        ...
        return "bbm/uss/umt/EntrprsMberInsert";
    }
     ...
     * @param model           화면모델
     * @return forward:/uss/umt/EntrprsMberManage.do
     * @throws Exception
     */
    @RequestMapping("/uss/umt/EntrprsMberInsert.do")
     ...
     * @param model 화면모델
     * @return uss/umt/EntrprsMberSelectUpdt
     * @throws Exception
     */
    @RequestMapping("/uss/umt/EntrprsMberSelectUpdtView.do")
    public String updateEntrprsMberView(
        ...
        return "bbm/uss/umt/EntrprsMberSelectUpdt";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/umt/EntrprsMberSelectUpdt.do")
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/umt/EntrprsMberDelete.do")
     ...
     * @param userSearchVO 검색조건정보
     * @param model 화면모델
     * @return uss/umt/EntrprsMberManage
     * @throws Exception
     */
    @IncludedInfo(name="기업회원관리", order = 450 ,gid = 50)
    @RequestMapping(value="/uss/umt/EntrprsMberManage.do")
    public String selectEntrprsMberList(
      ...
      //사용자상태코드를 코드정보로부터 조회
        ...
        return "bbm/uss/umt/EntrprsMberManage";
    } 
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/umt/EntrprsMberSbscrbView.do")
    public String sbscrbEntrprsMberView(
        ...
        return "bbm/uss/umt/EntrprsMberSbscrb";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/umt/EntrprsMberSbscrb.do")
     ...
     * @return uss/umt/EntrprsPasswordUpdt
     * @throws Exception
     */
    @RequestMapping(value="/uss/umt/EntrprsPasswordUpdt.do")
    public String updatePassword(
        ...
        return "bbm/uss/umt/EntrprsPasswordUpdt";
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/uss/umt/EntrprsPasswordUpdtView.do")
