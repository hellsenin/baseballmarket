package com.bbm.util.fda.ucc.service;
...
public class EgovUnitCalcUtil {
	...
	//길이
	HashMap<String, Double> g_hmVt = new HashMap();
	
	//부피
	HashMap<String, Double> g_hmVl = new HashMap();

	//넓이
	HashMap<String, Double> g_hmAr = new HashMap();
	
	//무게
	HashMap<String, Double> g_hmWt = new HashMap();
	...
	public double convertLengthCalcUnit(double nLength, String sLengthUnit, String sLengthUnitAs){
		...
		double nSelAr = (double)g_hmVt.get(sLengthUnit);
		double nSelArAs = (double)g_hmVt.get(sLengthUnitAs);
	...
	public double convertVolumeCalcUnit(double nVolume, String sVolumeUnit, String sVolumeUnitAs){
		...
		double nSelVl = (double)g_hmVl.get(sVolumeUnit);
		double nSelVlAs = (double)g_hmVl.get(sVolumeUnitAs);
	...
	public double convertWeightCalcUnit(double nWeight, String sWeightUnit, String sWeightUnitAs){
		...
		double nSelWt = (double)g_hmAr.get(sWeightUnit);
		double nSelWtAs = (double)g_hmAr.get(sWeightUnitAs);
	...
	public double convertWidthCalcUnit(double nWidth, String sWidthUnit, String sWidthUnitAs){
		...
		double nSelAr = (double)g_hmWt.get(sWidthUnit);
		double nSelArAs = (double)g_hmWt.get(sWidthUnitAs);
