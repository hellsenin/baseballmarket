 ...
 * </pre>
 */
@Service("ConfirmManageService")
public class ConfirmManageServiceImpl extends AbstractServiceImpl implements ConfirmManageService {
     ...
     * 
     * @see egovframework.com.cop.cmy.service.ConfirmManageService#insertConfirmRequest(egovframework.com.cop.cmy.service.ConfirmHistory)
     */
     ...
     * 
     * @see egovframework.com.cop.cmy.service.ConfirmManageService#selectConfirmRequest(egovframework.com.cop.cmy.service.ConfirmHistoryVO)
     */
     ...
     * 
     * @see egovframework.com.cop.cmy.service.ConfirmManageService#updateConfirmRequest(egovframework.com.cop.cmy.service.ConfirmHistory)
     */
...
//	 sttus 가 승인완료 AP02일때만 로직처리/ 승인반려시에는 승인정보만 변경처리 
     ...
     * 
     * @see egovframework.com.cop.cmy.service.ConfirmManageService#selectSingleConfirmRequest(egovframework.com.cop.cmy.service.ConfirmHistoryVO)
     */
     ...
     * 현재 승인 요청된 건수를 조회한다.
     * 
     * @see egovframework.com.cop.cmy.service.ConfirmManageService#countConfirmRequest(egovframework.com.cop.cmy.service.ConfirmHistoryVO)
     */
