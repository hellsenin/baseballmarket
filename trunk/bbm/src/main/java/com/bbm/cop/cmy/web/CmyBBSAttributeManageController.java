...
@Controller
public class CmyBBSAttributeManageController {
    ...
    private ClubManageService clubService;		// 동호회 운영자 권한 확인	
	...
	if (bindingResult.hasErrors()) {
	    ...
	    return "bbm/cop/bbs/EgovBdMstrRegistByTrget";
	}
	...
	return "bbm/cop/bbs/EgovBdMstrUpdtByTrget";
	}
	...
	return "bbm/cop/bbs/EgovBBSListByTrget";
	}
	...
	if (bindingResult.hasErrors()) {
	    ...
	    return "bbm/cop/bbs/EgovBoardMstrUpdt";
	}
	...
	return "bbm/cop/bbs/EgovBdListPortlet";
	}
