...
public class UserInfManageDAO extends EgovComAbstractDAO {
	...
	return list("UserInfManageDAO.selectUserList", userVO);
    }
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("UserInfManageDAO.selectUserListCnt", userVO);
    }
	...
	return list("UserInfManageDAO.selectCmmntyUserList", userVO);
    }
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("UserInfManageDAO.selectCmmntyUserListCnt", userVO);
    }
	...
	return list("UserInfManageDAO.selectCmmntyMngrList", userVO);
    }
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("UserInfManageDAO.selectCmmntyMngrListCnt", userVO);
    }
	...
	return list("UserInfManageDAO.selectClubUserList", userVO);
    }
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("UserInfManageDAO.selectClubUserListCnt", userVO);
    }
	...
	return list("UserInfManageDAO.selectClubOprtrList", userVO);
    }
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("UserInfManageDAO.selectClubOprtrListCnt", userVO);
    }
	...
	return list("UserInfManageDAO.selectAllClubUser", userVO);
    }
	...
	return list("UserInfManageDAO.selectAllCmmntyUser", userVO);
    }
}
