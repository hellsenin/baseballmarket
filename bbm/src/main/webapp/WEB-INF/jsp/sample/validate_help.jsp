...
JQ_setValidation('clCode');
<!--
/* ********************************************************
 * 목록 으로 가기
 *********************************************************/
function fn_egov_list_clCode(){
	location.href = "/adm/code/ClCodeList.do";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
 function fn_egov_regist_clCode(form){
	if(confirm("<spring:message code="common.save.msg" />")){
		
		JQ_request("clCode","<c:url value='/adm/code/ClCodeRegist.do'/>");
...
<DIV id="content" style="width: 712px"><!-- 상단타이틀 --> <form:form
	commandName="clCode" name="clCode" method="post">
	<!-- ----------------- 상단 타이틀  영역 -->
