...
<HEAD>
	...
	<LINK rel="stylesheet" type="text/css" href="css/common/jquery/themes/base/jquery.ui.all.css">
	...
	*/
	...
	<SCRIPT type="text/javascript" src="js/common/jquery/layout/jquery.layout-latest.js"></SCRIPT>

	<SCRIPT type="text/javascript" src="js/common/jquery/layout/jquery.layout.resizeTabLayout.min-1.2.js"></SCRIPT>
	<SCRIPT type="text/javascript" src="js/common/jquery/layout/jquery.layout.resizePaneAccordions.min-1.0.js"></SCRIPT>

    <SCRIPT type="text/javascript" src="js/common/jquery/layout/themeswitchertool.js"></SCRIPT> 
	<SCRIPT type="text/javascript" src="js/common/jquery/layout/debug.js"></SCRIPT>
