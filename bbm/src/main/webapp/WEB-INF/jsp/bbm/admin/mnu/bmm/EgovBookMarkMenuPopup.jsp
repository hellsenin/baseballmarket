...
<c:set var="ImgUrl" value="/images/bbm/admin/mnu/bmm/"/>
<c:set var="CssUrl" value="/css/bbm/admin/mnu/bmm/"/>
<%
String imagePath_icon   = "/images/bbm/admin/mnu/bmm/icon/";
String imagePath_button = "/images/bbm/admin/mnu/bmm/button/";
%>
<html lang="ko">
...
<table width="200" cellpadding="8" class="table-search" border="0">
    <tr>
    	<td width="10%" >
		    <img src="<c:url value='/images/bbm/admin/mnu/bmm/icon/menu_base.gif' />" width="20" height="20" hspace="3" style="vertical-align: middle" alt = "base icon">
		    </td>
	 ...
	 <c:forEach var="result" items="${list_menulist}" varStatus="status">
		  <tr>
		    ...
		    <td >
		    <img src="<c:url value='/images/bbm/admin/mnu/bmm/icon/menu_page.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt = "menu_page icon" >
		   		    </td>
		    <td class="lt_text1">
