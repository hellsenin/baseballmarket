...
<%
//String imagePath_icon   = "/images/bbm/admin/mnu/mpm/icon/";
//String imagePath_button = "/images/bbm/admin/mnu/mpm/button/";
%>
<html lang="ko">
<head>
...
<script language="javascript1.2" type="text/javaScript" src="<c:url value='/js/bbm/admin/mnu/mpm/EgovMenuList.js' />"></script>
...
function insertMenuList() {
	...
	document.menuManageVO.action = "<c:url value='/admin/mnu/mpm/MenuListInsert.do'/>";
	menuManageVO.submit();
...
function updateMenuList() {
	...
	document.menuManageVO.action = "<c:url value='/admin/mnu/mpm/MenuListUpdt.do'/>";
	menuManageVO.submit();
}
...
function deleteMenuList() {
    if(!fn_validatorMenuList()){return;}
    if(document.menuManageVO.tmp_CheckVal.value != "U"){alert("상세조회시는 수정혹은 삭제만 가능합니다."); return;}
	document.menuManageVO.action = "<c:url value='/admin/mnu/mpm/MenuListDelete.do'/>";
	menuManageVO.submit();
}
...
function selectMenuList() {
    document.menuManageVO.action = "<c:url value='/admin/mnu/mpm/MenuListSelect.do'/>";
...
function mvmnMenuList() {
	window.open("<c:url value='/admin/mnu/mpm/MenuListSelectMvmn.do' />",'Pop_Mvmn','scrollbars=yes,width=600,height=600');
}
...
function selectMenuListTmp() {
	document.menuManageVO.req_RetrunPath.value = "/admin/mnu/mpm/EgovMenuList";
    document.menuManageVO.action = "<c:url value='/admin/mnu/mpm/MenuListSelectTmp.do'/>";
    document.menuManageVO.submit();
}
...
<form name="menuManageVO" action ="<c:url value='/admin/mnu/mpm/MenuListInsert.do' />" method="post">
<input type="hidden" name="req_RetrunPath" value="/admin/mnu/mpm/EgovMenuList">
...
<div class="tree" style="position:absolute; left:100px; top:160px; width:240px; height:500px; z-index:10;">
   ...
   <td width="*" class="title_left">
	   <table border="0" cellspacing="0" cellpadding="0" align="left">
		<tr>
          <td width="90%"></td>
          <td><span class="button"><a href="<c:url value='/admin/mnu/mpm/MenuListSelect.do'/>" onclick="initlMenuList(); return false;">초기화</a></span></td>
          <td width="2%"></td>
   ...
   <td width="70%" class="title_left">
	...
	<caption>메뉴리스트정보 </caption>
		  ...
		  <tr>
	        ...
	        <a href="/admin/mnu/mpm/EgovMenuListSelectMvmn.do" target="_blank" title="새창으로" onClick="mvmnMenuList();return false;"  style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/com/cmm/search2.gif' />"
