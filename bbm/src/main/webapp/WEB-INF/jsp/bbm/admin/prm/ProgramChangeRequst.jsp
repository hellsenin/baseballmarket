...
//	document.progrmChangeRequstForm.searchKeyword.value =
	...
	document.progrmChangeRequstForm.action = "<c:url value='/admin/prm/ProgramChangeRequstSelect.do'/>";
...
function insertChangeRequst() {
   	document.progrmChangeRequstForm.action = "<c:url value='/admin/prm/ProgramChangRequstStre.do'/>";
   	document.progrmChangeRequstForm.submit();
}
...
function selectUpdtChangeRequstListDetail(progrmFileNm, tmpNo) {
	...
	document.progrmChangeRequstForm.action = "<c:url value='/admin/prm/ProgramChangRequstDetailSelect.do'/>";
	document.progrmChangeRequstForm.submit();
}
...
<form name="progrmChangeRequstForm" action ="<c:url value='/admin/prm/ProgramChangeRequstSelect.do'/>?pageIndex=1" method="post">
  ...
  <tr>
    ...
    <td width="25%" height="10">&nbsp;
          <table border="0" cellspacing="0" cellpadding="0" align="right">
            <tr>
              <td width="5%"></td>
              <td><span class="button"><a href="<c:url value='/admin/prm/ProgramChangRequstStre.do'/>" onclick="insertChangeRequst(); return false;"><spring:message code="button.create" /></a></span></td>
              <td width="10"></td>
            </tr>
          </table>
    </td>
 ...
 <c:forEach var="result" items="${list_changerequst}" varStatus="status">
  <tr>
    ...
    <td class="lt_text" style="cursor:hand;" nowrap>
      <form name="item" method="post" action="<c:url value='/admin/prm/ProgramChangRequstDetailSelect.do'/>">
