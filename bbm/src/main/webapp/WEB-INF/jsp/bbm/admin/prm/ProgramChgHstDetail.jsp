 ...
 ******************************************************** */
function selectList(){
	location.href = "<c:url value='/admin/prm/ProgramChgHstListSelect.do' />";
}
-->
</script>
</head>
...
<table border="0">
  <tr>
    <td width="700">
<!-- ********** 여기서 부터 본문 내용 *************** -->
<form name="progrmChangeRequstForm" action ="<c:url value='/admin/prm/ProgramChgHstListSelect.do'/>" method="post">
