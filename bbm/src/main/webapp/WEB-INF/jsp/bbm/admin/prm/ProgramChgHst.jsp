...
//	document.programChgHstForm.searchKeyword.value =
	...
	document.programChgHstForm.action = "<c:url value='/admin/prm/ProgramChgHstListSelect.do'/>";
...
function selectChgHstListDetail(progrmFileNm, tmp_no) {
	...
	document.programChgHstForm.action = "<c:url value='/admin/prm/ProgramChgHstListDetailSelect.do'/>";
	document.programChgHstForm.submit();
}
-->
</script>
...
<table border="0">
  <tr>
    <td width="700">
<!-- ********** 여기서 부터 본문 내용 *************** -->
<form name="programChgHstForm" action ="<c:url value='/admin/prm/ProgramChgHstListSelect.do'/>" method="post">
 ...
 <c:forEach var="result" items="${list_changerequst}" varStatus="status">
  <tr>
    <td class="lt_text3" style="cursor:hand;" nowrap>
        <form name="item" method="post" action="<c:url value='/admin/prm/ProgramChgHstListDetailSelect.do'/>">
