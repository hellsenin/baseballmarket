...
<c:set var="ImgUrl" value="${pageContext.request.contextPath}/images/bbm/admin/mnu/mpm/"/>
<html lang="ko">
<head>
...
<form:form commandName="menuManageVO" name="menuManageVO" method="post" action="${pageContext.request.contextPath}/admin/mnu/mpm/MenuRegistInsert.do">
...
<table border="0" cellspacing="0" cellpadding="0">
 <tr>
      <td width="90%"></td>
      <td><span class="button"><a href="<c:url value='/admin/mnu/mpm/MenuManageSelect.do'/>" onclick="javascript:selectList(); return false;">목록</a></span></td>
      <td width="2%"></td>
