...
function searchFileNm() {
	...
	window.open("<c:url value='/admin/prm/ProgramListSearch.do' />",'','width=500,height=600');
}
...
function insertProgrmChangeRequst(form) {
	if(confirm("<spring:message code="common.save.msg" />")){
		...
		if(!validateProgrmManageDtlVO(form)){
            ...
            form.action = "<c:url value='/admin/prm/ProgramChangRequstStre.do'/>";
			form.submit();
		}
	}
 ...
 ******************************************************** */
function selectList(){
	location.href = "<c:url value='/admin/prm/ProgramChangeRequstSelect.do' />";
}
...
<form:form commandName="progrmManageDtlVO" name="progrmManageDtlVO" action ="<c:url value='/admin/prm/ProgramChangRequstStre.do'/>" method="post">
...
<table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register"   summary="프로그램변경요청 ">
  ...
  <tr>
    ...
    <td width="527" nowrap>&nbsp;
        ...
        <a href="<c:url value='/admin/prm/ProgramListSearch.do'/>?tmp_SearchElementName=progrmFileNm" target="_blank" onclick="javascript:searchFileNm(); return false;" style="selector-dummy:expression(this.hideFocus=false);"  title="새 창으로 이동">
...
<tr>
  <td width="90%"></td>
  <td><span class="button"><a href="<c:url value='/admin/prm/ProgramChangeRequstSelect.do'/>" onclick="selectList(); return false;">목록</a></span></td>
  <td width="5%"></td>
