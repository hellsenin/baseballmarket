...
<%
 /**
  * @Class Name  : ClCodeRegist.jsp
  * @Description : ClCodeRegist 화면
...
<tr>
  <td><span class="button"><input type="submit" value="저장" onclick="fn_egov_regist_CmmnClCode(document.clCode); return false;"></span></td>
  <td width="1"></td>
...
<!--
  ...
  <td style="background-image:URL(<c:url value='/images/egovframework/com/cmm/btn/bu2_bg.gif'/>);" class="text_left" nowrap><a href="JavaScript:javascript:fn_egov_regist_CmmnClCode(document.clCode);">저장</a></td>
