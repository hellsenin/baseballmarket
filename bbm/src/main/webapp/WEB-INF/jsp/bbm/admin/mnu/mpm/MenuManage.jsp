...
function fDeleteMenuList() {
    ...
    document.menuManageForm.action = "<c:url value='/admin/mnu/mpm/MenuManageListDelete.do'/>";
...
//	document.menuManageForm.searchKeyword.value =
	...
	document.menuManageForm.action = "<c:url value='/admin/mnu/mpm/MenuManageSelect.do'/>";
   	document.menuManageForm.submit();
}
...
function insertMenuManage() {
   	document.menuManageForm.action = "<c:url value='/admin/mnu/mpm/MenuRegistInsert.do'/>";
   	document.menuManageForm.submit();
}
 ...
 */
function bndeInsertMenuManage() {
   	document.menuManageForm.action = "<c:url value='/admin/mnu/mpm/MenuBndeRegist.do'/>";
   	document.menuManageForm.submit();
}
/* ********************************************************
 * 상세조회처리 함수
...
function selectUpdtMenuManageDetail(menuNo) {
	document.menuManageForm.req_menuNo.value = menuNo;
   	document.menuManageForm.action = "<c:url value='/admin/mnu/mpm/MenuManageListDetailSelect.do'/>";
   	document.menuManageForm.submit();
}
/* ********************************************************
 * 최초조회 함수
...
<table border="0">
  <tr>
    <td width="700">
<!-- ********** 여기서 부터 본문 내용 *************** -->
<form name="menuManageForm" action ="<c:url value='/admin/mnu/mpm/MenuManageSelect.do'/>" method="post">
  ...
  <tr>
    ...
    <td width="25%" height="10">&nbsp;
       <table border="0" cellspacing="0" cellpadding="0" summary="메뉴관리 처리버튼">
        ...
        <tr>
             <td><span class="button"><a href="<c:url value='/admin/mnu/mpm/MenuRegistInsert.do'/>" onclick="bndeInsertMenuManage(); return false;">일괄등록</a></span></td>
             <td width="5%"></td>
             <td><span class="button"><a href="<c:url value='/admin/mnu/mpm/MenuRegistInsert.do'/>" onclick="insertMenuManage(); return false;"><spring:message code="button.create" /></a></span></td>
             <td width="5%"></td>
 ...
 <c:forEach var="result" items="${list_menumanage}" varStatus="status">
  <tr>
    ...
    <td class="lt_text" style="cursor:hand;">
       <span class="link"><a href="<c:url value='/admin/mnu/mpm/MenuManageListDetailSelect.do?req_menuNo='/>${result.menuNo}" onclick="selectUpdtMenuManageDetail('<c:out value="${result.menuNo}"/>'); return false;"><c:out value="${result.menuNm}"/></a></span>
    </td>
