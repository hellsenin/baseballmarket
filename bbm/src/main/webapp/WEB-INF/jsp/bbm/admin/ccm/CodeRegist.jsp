<%
 /**
  * @Class Name  : CodeRegist.jsp
  * @Description : CodeRegist 화면
...
<validator:javascript formName="code" staticJavascript="false" xhtml="true" cdata="false"/>
...
function fn_egov_list_CmmnCode(){
	location.href = "<c:url value='/admin/ccm/CodeList.do' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
  ...
  <tr>
    ...
    <td width="80%" nowrap colspan="3">
		<select name="clCode" class="select" id="clCode">
			<c:forEach var="result" items="${clCode}" varStatus="status">
...
<tr> 
  ...
  <td><span class="button"><input type="submit" value="저장" onclick="fn_egov_regist_CmmnCode(document.code); return false;"></span></td>     
</tr>
</table>
