...
//	document.menuManageForm.searchKeyword.value =
	...
	document.progrmManageForm.action = "<c:url value='/admin/prm/ProgramListManageSelect.do'/>";
   	document.progrmManageForm.submit();
}
...
function insertProgramListManage() {
   	document.progrmManageForm.action = "<c:url value='/admin/prm/ProgramListRegist.do'/>";
   	document.progrmManageForm.submit();
}
/* ********************************************************
 * 상세조회처리 함수
...
function selectUpdtProgramListDetail(progrmFileNm) {
	document.progrmManageForm.tmp_progrmNm.value = progrmFileNm;
   	document.progrmManageForm.action = "<c:url value='/admin/prm/ProgramListDetailSelect.do'/>";
   	document.progrmManageForm.submit();
}
/* ********************************************************
 * focus 시작점 지정함수
...
<form name="progrmManageForm" action ="<c:url value='/admin/prm/ProgramListManageSelect.do' />" method="post">
        ...
        <td width="80%">
          <table border="0" cellspacing="0" cellpadding="0" align="left">
            <tr>
              ...
              <td width="5%"></td>
              <td width="20%"><span class="button"><a href="<c:url value='/admin/prm/ProgramListRegist.do'/>" onclick="insertProgramListManage(); return false;"><spring:message code="button.create" /></a></span></td>
              <td width="5%"></td>
 ...
 <c:forEach var="result" items="${list_progrmmanage}" varStatus="status">
  <tr>
    ...
    <td class="lt_text" style="cursor:hand;" nowrap>
            <span class="link"><a href="<c:url value='/admin/prm/ProgramListDetailSelect.do'/>?tmp_progrmNm=<c:out value="${result.progrmFileNm}"/>"  onclick="selectUpdtProgramListDetail('<c:out value="${result.progrmFileNm}"/>'); return false;">
