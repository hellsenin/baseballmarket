...
function updateProgramListManage(form) {
	if(confirm("<spring:message code="common.save.msg" />")){
		if(!validateProgrmManageVO(form)){
            ...
            form.action="<c:url value='/admin/prm/ProgramListDetailSelectUpdt.do' />";
			form.submit();
		}
	}
}
...
function deleteProgramListManage(form) {
	if(confirm("<spring:message code="common.delete.msg" />")){
        form.action="<c:url value='/admin/prm/ProgramListManageDelete.do' />";
		form.submit();
	}
}
 ...
 ******************************************************** */
function selectList(){
	location.href = "<c:url value='/admin/prm/ProgramListManageSelect.do' />";
}
  ...
  <tr>
    <td>
		...
		<tr>
          ...
          <td><span class="button"><a href="<c:url value='/admin/prm/ProgramListManageSelect.do'/>" onclick="selectList(); return false;">목록</a></span></td>
          <td width="5%"></td>
          ...
          <td width="5%"></td>
          <td><span class="button"><a href="<c:url value='/admin/prm/ProgramListManageDelete.do'/>?progrmFileNm=<c:out value="${progrmManageVO.progrmFileNm  }"/>" onclick="deleteProgramListManage(document.forms[0]); return false;"><spring:message code="button.delete" /></a></span></td>
		</tr>
		</table>
    </td>
  </tr>
