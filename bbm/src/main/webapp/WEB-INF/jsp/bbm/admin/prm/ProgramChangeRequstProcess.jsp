...
function linkPage(pageNo){
	...
	document.programChangeRequstProcessListForm.action = "<c:url value='/admin/prm/ProgramChangeRequstProcessListSelect.do'/>";
...
function selectChangeRequstProcessListDetail(progrmFileNm, tmpNo) {
	...
	document.programChangeRequstProcessListForm.action = "<c:url value='/admin/prm/ProgramChangRequstProcessDetailSelect.do'/>";
	document.programChangeRequstProcessListForm.submit();
}
 ...
 <c:forEach var="result" items="${list_changerequst}" varStatus="status">
  ...
  <tr>
    ...
    <td class="lt_text" style="cursor:hand;" nowrap>
        <form name="item" method="post" action="<c:url value='/admin/prm/ProgramChangRequstProcessDetailSelect.do'/>">
