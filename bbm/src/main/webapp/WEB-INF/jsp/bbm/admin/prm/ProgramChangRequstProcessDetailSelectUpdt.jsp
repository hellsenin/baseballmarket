...
function updateChangRequstProcess(form) {
	if(confirm("<spring:message code="common.save.msg"/>")){
		if(!validateProgrmManageDtlVO(form)){
            ...
            form.action ="<c:url value='/admin/prm/ProgramChangRequstProcessDetailSelectUpdt.do' />";
			form.submit();
		}
	}
}
...
function deleteChangRequstProcess(form) {
   form.action = "<c:url value='/admin/prm/ProgramChangeRequstProcessDelete.do' />";
   form.submit();
}
 ...
 ******************************************************** */
function selectList(){
	location.href = "<c:url value='/admin/prm/ProgramChangeRequstProcessListSelect.do' />";
}
...
<table width="717" border="0" cellspacing="0" cellpadding="0" align="left">
	<tr>
	  <td width="90%"></td>
	  <td><span class="button"><a href="<c:url value='/admin/prm/ProgramChangeRequstProcessListSelect.do'/>" onclick="selectList(); return false;">목록</a></span></td>
	  <td width="5%"></td>
