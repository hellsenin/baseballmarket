...
<%
 /**
  * @Class Name  : DetailCodeList.jsp
  * @Description : DetailCodeList 화면
...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/admin/ccm/DetailCodeList.do'/>";
 ...
 ******************************************************** */
function fnRegist(){
	location.href = "<c:url value='/admin/ccm/DetailCodeRegist.do' />";
}
/* ********************************************************
 * 수정 처리 함수
 ******************************************************** */
...
function fnDetail(codeId, code){
	...
	varForm.action           = "<c:url value='/admin/ccm/DetailCodeDetail.do'/>";
...
<form name="listForm" action="<c:url value='/admin/ccm/DetailCodeList.do'/>" method="post">
  ...
  <th width="10%">
   <table border="0" cellspacing="0" cellpadding="0">
	...
	<!--
      ...
      <td background="<c:url value='/images/egovframework/com/cmm/btn/bu2_bg.gif' />" class="text_left" nowrap><a href="#noscript" onclick="fnRegist(); return false;">등록</a></td>
...
<tr>
	...
	<td class="lt_text" nowrap>
		<span class="link">
			<a href="<c:url value='/admin/ccm/DetailCodeDetail.do'/>?codeId=${resultInfo.codeId}&amp;code=${resultInfo.code}" onclick="javascript:fnDetail('${resultInfo.codeId}','${resultInfo.code}');">
			${resultInfo.codeNm}
			</a>
		</span>
	</td>
