...
<c:set var="ImgUrl" value="/images/bbm/admin/mnu/mpm/"/>
<head>
...
function updateMenuManage(form) {
	...
	if(confirm("<spring:message code="common.save.msg"/>")){
		...
		if(!validateMenuManageVO(form)){
            ...
            form.action="<c:url value='/admin/mnu/mpm/MenuDetailSelectUpdt.do' />";
			form.submit();
		}
	}
}
...
function deleteMenuManage(form) {
	if(confirm("<spring:message code="common.delete.msg"/>")){
        form.action="<c:url value='/admin/mnu/mpm/MenuManageDelete.do' />";
		form.submit();
	}
}
/* ********************************************************
 ...
 ******************************************************** */
function selectList(){
	location.href = "<c:url value='/admin/mnu/mpm/MenuManageSelect.do' />";
}
...
<form:form commandName="menuManageVO" name="menuManageVO"  action ="<c:url value='/admin/mnu/mpm/MenuDetailSelectUpdt.do' />" method="post">
...
<table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="메뉴상세정보" >
  ...
  <tr>
    ...
    <td width="35%" >&nbsp;
      ...
      <a href="<c:url value='/admin/mnu/mpm/MenuListSelectMvmn.do' />" target="_blank" title="새창으로" onClick="mvmnMenuList();return false;"  style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/com/cmm/search2.gif' />"
...
<table width="717" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="10">
		...
		<tr>
		  <td width="90%"></td>
          <td><span class="button"><a href="<c:url value='/admin/mnu/mpm/MenuManageSelect.do'/>" onclick="selectList(); return false;">목록</a></span></td>
          <td width="2%"></td>
