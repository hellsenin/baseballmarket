...
<%
 /**
  * @Class Name  : CodeModify.jsp
  * @Description : CodeModify 화면
...
-->
  ...
  <td><span class="button"><input type="submit" value="저장" onclick="fn_egov_modify_CmmnCode(document.code); return false;"></span></td>
</tr>
</table>
</td></tr>
</table>
