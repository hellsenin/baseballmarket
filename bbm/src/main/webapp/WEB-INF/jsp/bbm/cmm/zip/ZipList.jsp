...
<link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/com/cmm/zip/zip.css'/>">
...
function fn_egov_pageview(pageNo){
	...
	document.listForm.action = "<c:url value='/cmm/zip/ZipList.do'/>";
...
//	location.href = "<c:url value='/cmm/zip/ZipRegist.do'/>";
	var varForm	   			 = document.getElementById("Form");
	varForm.action 			 = "<c:url value='/cmm/zip/ZipRegist.do'/>";
...
//	location.href = "<c:url value='/cmm/zip/ExcelZipRegist.do' />";
	var varForm	   			 = document.getElementById("Form");
	varForm.action 			 = "<c:url value='/cmm/zip/ExcelZipRegist.do'/>";
	varForm.searchList.value = document.getElementById("searchList").value;
	varForm.submit();
}
/* ********************************************************
...
function fn_egov_detail_Zip(zip,sn){
	var varForm				 = document.getElementById("Form");
	varForm.action           = "<c:url value='/cmm/zip/ZipDetail.do'/>";
...
<form name="listForm" action="<c:url value='/cmm/zip/ZipList.do'/>" method="post">
