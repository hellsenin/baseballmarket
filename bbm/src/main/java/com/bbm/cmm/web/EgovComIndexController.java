...
import com.bbm.cmm.IncludedCompInfoVO;
...
public class EgovComIndexController implements ApplicationContextAware ,InitializingBean {
	...
	public String setLeftMenu(ModelMap model){
		...
		if(map == null){
			 ...
			 */
			try{
				Class loginController = Class.forName("com.bbm.uat.uia.web.EgovLoginController");
				...
				LOG.error("No com.bbm.uat.uia.web.EgovLoginController!!");
			}
