package com.bbm.cop.cmy.service.impl;
...
import com.bbm.cop.bbs.service.BoardMaster;
import com.bbm.cop.bbs.service.BoardUseInf;
import com.bbm.cop.bbs.service.BoardUseInfVO;
import com.bbm.cop.cmy.service.CmyBBSUseInfoManageService;
import com.bbm.cop.cmy.service.Community;
import com.bbm.cop.cmy.service.CommunityManageService;
import com.bbm.cop.cmy.service.CommunityUser;
import com.bbm.cop.cmy.service.CommunityUserVO;
import com.bbm.cop.cmy.service.CommunityVO;
 ...
 *  -------    --------    ---------------------------
 *   2009.4.2   이삼섭          최초 생성
 *   2011.07.27 안민정 		    동호회, 커뮤니티 종속성 제거 (EgovBBSUseInfoManageService -> CmyBBSUseInfoManageService)
 *
 * </pre>
 */
@Service("CommunityManageService")
public class CommunityManageServiceImpl extends AbstractServiceImpl implements CommunityManageService {

    @Resource(name = "BBSAttributeManageService")
    private BBSAttributeManageService bbsAttrbService;

    @Resource(name = "CmyBBSUseInfoManageService")
    private CmyBBSUseInfoManageService bbsUseService;
     ...
     * 커뮤니티에 대한 정보를 삭제한다.
     * 
     * @see egovframework.com.cop.cmy.service.CommunityManageService#deleteCommunityInf(egovframework.com.cop.cmy.service.Community)
     */
     ...
     * 커뮤니티 사용정보를 삭제한다.
     * 
     * @see egovframework.com.cop.cmy.service.CommunityManageService#deleteCommunityUserInf(egovframework.com.cop.cmy.service.CommunityUser)
     */
     ...
     * 
     * @see egovframework.com.cop.cmy.service.CommunityManageService#insertCommunityBBSUseInf(egovframework.com.cop.bbs.service.com.service.BoardUseInf)
     */
     ...
     * 커뮤니티에 대한 정보를 등록한다.
     * 
     * @see egovframework.com.cop.cmy.service.CommunityManageService#insertCommunityInf(egovframework.com.cop.cmy.service.Community)
     */
	...
	*/
     ...
     * 커뮤니티 사용자 정보를 등록한다.
     * 
     * @see egovframework.com.cop.cmy.service.CommunityManageService#insertCommunityUserInf(egovframework.com.cop.cmy.service.CommunityUser)
     */
     ...
     * 커뮤니티 사용자 정보를 확인한다.
     * 
     * @see egovframework.com.cop.cmy.service.CommunityManageService#checkCommunityUserInf(egovframework.com.cop.cmy.service.CommunityUser)
     */
     ...
     * 
     * @see egovframework.com.cop.cmy.service.CommunityManageService#selectCommunityBBSUseInf(egovframework.com.cop.cmy.service.CommunityVO)
     */
     ...
     * 
     * @see egovframework.com.cop.cmy.service.CommunityManageService#selectCommunityInf(egovframework.com.cop.cmy.service.CommunityVO)
     */
     ...
     * 커뮤니티 정보 목록을 조회한다.
     * 
     * @see egovframework.com.cop.cmy.service.CommunityManageService#selectCommunityInfs(egovframework.com.cop.cmy.service.CommunityVO)
     */
     ...
     * 
     * @see egovframework.com.cop.cmy.service.CommunityManageService#selectCommunityUserInfs(egovframework.com.cop.cmy.service.CommunityUserVO)
     */
     ...
     * 커뮤니티 게시판 사용정보를 수정한다.
     * 
     * @see egovframework.com.cop.cmy.service.CommunityManageService#updateCommunityBBSUseInf(egovframework.com.cop.bbs.service.com.service.BoardUseInf)
     */
     ...
     * 커뮤니티 정보를 수정한다.
     * 
     * @see egovframework.com.cop.cmy.service.CommunityManageService#updateCommunityInf(egovframework.com.cop.cmy.service.Community)
     */
     ...
     * 커뮤니티 사용자 정보를 수정한다.
     * 
     * @see egovframework.com.cop.cmy.service.CommunityManageService#updateCommunityUserInf(egovframework.com.cop.cmy.service.CommunityUser)
     */
     ...
     * 
     * @see egovframework.com.cop.cmy.service.CommunityManageService#selectCmmntyListPortlet(egovframework.com.cop.cmy.service.CommunityVO)
     */
     ...
     * 커뮤니티용 템플릿 경로명을 조회한다.
     * 
     * @see egovframework.com.cop.cmy.service.CommunityManageService#selectCmmntyTemplat(egovframework.com.cop.cmy.service.CommunityVO)
     */
     ...
     * 모든 커뮤니티 목록을 조회한다.
     * 
     * @see egovframework.com.cop.cmy.service.CommunityManageService#selectAllCmmnty(egovframework.com.cop.cmy.service.CommunityVO)
     */
