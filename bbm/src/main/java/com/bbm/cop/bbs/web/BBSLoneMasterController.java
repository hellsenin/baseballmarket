...
import com.bbm.cop.bbs.service.BBSLoneMasterService;
...
@Controller
public class BBSLoneMasterController {




	@Resource(name = "BBSLoneMasterService")
    private BBSLoneMasterService bbsLoneService;
...
//    @IncludedInfo(name="게시판관리", order = 170 ,gid = 40)
	...
	return "bbm/cop/bbs/BBSLoneMstrList";
    }
	...
	return "bbm/cop/bbs/BBSLoneMstrUpdt";
    }
